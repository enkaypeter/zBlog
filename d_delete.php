 <?php
    ...
    if($counter >= 1){
      ...
      if(isset($_POST['update'])){
        ...
        $postSq = "DELETE FROM Post WHERE ID = $id";
        // var_dump($postSq); die();
        ...
        if($postCont >= 1){
                $msg = '<p class="success"> Item Deleted sucessfully!!!</p>';
            }else{
                 $msg = '<p class="error"> Could not Delete Item from Database. Please Try again!</p>';
            }
  ...
  <?php //echo $counter;  echo $id; ?>
    ...
    <div class="jumbotron">
      <div class="text-center">
          <h1>Welcome to me Blog Delete Panel</h1>
          <small>help yourself with the Delete options below</small>
          <p>...</p>
